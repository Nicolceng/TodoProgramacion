	...
	public static void main(String[] args) {
		...
		String iva,promocion = null;
			...
			iva = teclado1.nextLine();
				...
				System.out.println("El iva aplicado es de tipo general-> "+ calculoiva);
				...
				promocion = teclado2.nextLine();
					...
					System.out.println("El iva aplicado es de tipo reducido-> "+ calculoiva);
					calculoiva=calculoiva+preciobase;
					System.out.println("Su precio con IVA es-> "+calculoiva);
					System.out.print("Introduzca ahora su codigo promocional (nopro, mitad, meno5, 5porc) : ");
					promocion = teclado2.nextLine();
					...
					System.out.println("El iva aplicado es de tipo superreducido-> "+ calculoiva);
					calculoiva=calculoiva+preciobase;
					System.out.println("Su precio con IVA es-> "+calculoiva);
					System.out.print("Introduzca ahora su codigo promocional (nopro, mitad, meno5, 5porc) : ");
					promocion = teclado2.nextLine();
				...
				if(promocion.equalsIgnoreCase("mitad")) {
					...
					System.out.println("Su precio total con el descuento (mitad) aplicado es de: "+calculopromo+ " Euros");
				...
				if(promocion.equalsIgnoreCase("meno5")) {
					...
					System.out.println("Su precio total con el descuento (meno5) aplicado es de: "+calculopromo+ " Euros");
				...
				if(promocion.equalsIgnoreCase("5porc")) {
					...
					System.out.println("Su precio total con el descuento (5porc) aplicado es de: "+(calculoiva-calculopromo)+ " Euros");
